...
def NetServerSetInfo(server: Union[str, None], level: int, data: Mapping[Incomplete, Incomplete], /) -> None: ...
...
def NetShareAdd(server: Union[str, None], level: int, data: Mapping[Incomplete, Incomplete], /) -> None: ...
...
def NetShareSetInfo(server: Union[str, None], netname: str, level: int, data: Mapping[Incomplete, Incomplete], /) -> None: ...
def NetStatisticsGet(
    server: Union[str, None], service: str, level: int = ..., options: int = ..., /
) -> dict[Incomplete, Incomplete]: ...
def NetUseAdd(server: Union[str, None], level: int, data: Mapping[Incomplete, Incomplete], /) -> None: ...
...
def NetUserAdd(server: Union[str, None], level: int, data: Mapping[Incomplete, Incomplete], /) -> None: ...
...
def NetUserModalsSet(server: Union[str, None], level: int, data: Mapping[Incomplete, Incomplete], /) -> None: ...
def NetUserSetInfo(server: Union[str, None], username: str, level: int, data: Mapping[Incomplete, Incomplete], /) -> None: ...
def NetValidateName(
...
def NetWkstaSetInfo(server: Union[str, None], level: int, data: Mapping[Incomplete, Incomplete], /) -> None: ...
def NetWkstaTransportAdd(server: Union[str, None], level: int, data: Mapping[Incomplete, Incomplete], /) -> None: ...
